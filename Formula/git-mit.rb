class GitMit < Formula
  ...
  url "https://github.com/PurpleBooth/git-mit/archive/v4.0.26.tar.gz"
  sha256 "536f3b5a695b7be07d0ea73055a23a2a04dfcd73c6003467293d2bba4b1fb12e"

  bottle do
    root_url "https://github.com/PurpleBooth/homebrew-repo/releases/download/git-mit-4.0.26"
    sha256 cellar: :any,                 catalina:     "9c9579d8f6f39509dee7400cad63189fa30af692780a30b627220b314bf4edfa"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "c548c8206483f107826450ad84632638b84e9b09bed3028eff9c217eeeb471fa"
  end
